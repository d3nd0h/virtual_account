        ...
        <div class="col-md-6 col-sm-12">
            <div class="box box-solid box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Account with ID - {{ $account->id }}</h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        <label for="name" class="col-xs-12 col-md-2">Name</label>
                        <p class="col-xs-12 col-md-10">{{ $account->name }}</p>
                    </div>
                    <div class="form-group">
                        <label for="birthdate" class="col-xs-12 col-md-2">Birthdate</label>
                        <p class="col-xs-12 col-md-10">{{ $account->birthdate }}</p>
                    </div>
                    <div class="form-group">
                        <label for="address" class="col-xs-12 col-md-2">Address</label>
                        <p class="col-xs-12 col-md-10">{{ $account->address }}</p>
                    </div>
                    <div class="form-group">
                        <label for="phone" class="col-xs-12 col-md-2">Phone</label>
                        <p class="col-xs-12 col-md-10">{{ $account->phone }}</p>
                    </div>
                    <div class="form-group">
                        <label for="phone" class="col-xs-12 col-md-2">Balance</label>
                        <p class="col-xs-12 col-md-10">Rp. {{ $balance }},-</p>
                    </div>
                </div>
            </div>
            <!-- /.box -->
        ...
        <div class="col-xs-12 col-md-8">
            <div class="box table-responsive">
                <div class="box-header">
                    <h3 class="box-title">List of Account Transactions.</h3>
                    <button class="btn btn-md btn-success pull-right" data-toggle="modal" data-target="#add_transaction"><span class="fa fa-plus"></span></button>
                    <div class="modal fade modal-success" id="add_transaction">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['url' => route('admin.transaction.store'), 'class' => 'form-group']) !!}
                        ...
                        <tbody>
                            @foreach ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#delete_modal_{{ $transaction->id }}"><span class="fa fa-remove"></span></button>
                                        ...
                                        <button class="btn btn-xs btn-info" data-toggle="modal" data-target="#edit_modal_{{ $transaction->id }}"><span class="fa fa-edit"></span></button>
