        ...
        <div class="col-md-6 col-sm-12">
            <div class="box box-solid box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">User with ID - {{ $user->id }}</h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        <label for="username" class="col-xs-12 col-md-2">Username</label>
                        <p class="col-xs-12 col-md-10">{{ $user->username }}</p>
                    </div>
                    <div class="form-group">
                        <label for="name" class="col-xs-12 col-md-2">Name</label>
                        <p class="col-xs-12 col-md-10">{{ $user->name }}</p>
                    </div>
                </div>
            </div>
            <!-- /.box -->
        ...
        <div class="col-xs-12 col-md-8">
            <div class="box table-responsive">
                <div class="box-header">
                    <h3 class="box-title">List of Authorized Transactions.</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
